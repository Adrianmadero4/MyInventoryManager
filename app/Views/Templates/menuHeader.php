...
<header class="container py-3">
    <div class=" container-fluid d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
      ...
      <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
        ...
        <a class="me-3 py-2 text-dark text-decoration-none" href="<?php echo base_url('contact'); ?>">Conocenos</a>
        <a class="me-3 py-2 text-dark text-decoration-none" href="<?php echo base_url('pricing'); ?>">Precios</a>
        <a class="py-2 text-dark text-decoration-none" href="<?php echo base_url('login'); ?>">Iniciar Sesión</a>
      </nav>
    </div>
  </header>
