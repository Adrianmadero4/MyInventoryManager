<div class="container">
    <p>Puedes cambiar el nombre o la foto de tu sección <span style="font-size: larger;"><?= esc($sections['nombre_seccion']) ?></span>. </p>
    ...
    <?php if (! empty($sections) && is_array($sections)):?>
        ...
        <form action="<?= base_url('secciones/update/updated/') .($sections['id']) ?>"  method="post">
            ...
            <div class="form-group>
                <label for="nombre_seccion">Nombre de la seccion</label>
                <input type="input" name="nombre_seccion" value="<?= esc ($sections['nombre_seccion']) ?>"> 
            </div>
            <br>
