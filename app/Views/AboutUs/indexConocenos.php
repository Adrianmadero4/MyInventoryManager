	...
	<div class="container">
        ...
        <img src="public/images/abousUsImgConocenos.jpg" class="img-fluid" alt="Imagen de referencia">
          ...
          <!-- <img src="public/images/imgProducts.png" alt="Imagen 1" style="width: 100%;" class="me-2"> -->
			...
			<div class="col-md-6 offset-md-1 paddingTopBottom">
...
<section class="py-5 bg-light">
  <div class="container ">
    <div class="row">
      <div class="col-md-5">
        <h2 class="display-5 fw-bold mb-4  text-center">Preguntas Frecuentes</h2>
      ...
      <div class="col-md-6 offset-md-1 display-5 fw-bold mb-4  text-center">
        <aside class="bgWhite">
